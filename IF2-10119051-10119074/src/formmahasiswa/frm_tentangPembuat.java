...
public class frm_tentangPembuat extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Program Form Mahasiswa");
        ...
        jLabel3.setText("HANDRIAN RIVALDI -10119074");
        ...
        jLabel4.setText("RAHMAYUDHI PRAKOSO - 10119051");
        ...
        jLabel6.setText("TugasBesar POVIS IF2 /2021");
        ...
        jLabel9.setText("Simulasi Kasus Bon/Nota Transaksi");
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 70, -1, 20));
        ...
        jLabel10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/formmahasiswa/instagram.png"))); // NOI18N
        jLabel10.setText("jLabel10");
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 240, 40, -1));

        jLabel12.setBackground(new java.awt.Color(255, 255, 51));
        jLabel12.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 0));
        jLabel12.setText("@hripay");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 250, -1, -1));

        jLabel13.setBackground(new java.awt.Color(255, 255, 51));
        jLabel13.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 0));
        jLabel13.setText("@rahmayudhi");
        getContentPane().add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 250, -1, -1));

        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/formmahasiswa/Vektor.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_tentangPembuat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_tentangPembuat().setVisible(true);
            }
        });
    }
